#define SCREEN ((unsigned char *)0x800000)
#define SCREEN_CTRL ((volatile unsigned char *)0x8FFFFF)
#define DIVER ((volatile unsigned char *)0xFFFFFFFF)

#define SCREEN_CLC ((volatile unsigned char)0)
#define SCREEN_REF ((volatile unsigned char)1)
